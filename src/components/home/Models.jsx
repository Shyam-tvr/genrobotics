...
const modelDetails = [
  {
    ...
    description:
      "In this model, we provide you with our cutting-edge robotic products and conduct comprehensive training for your existing employees. This empowers your team to proficiently operate and manage the robotic solutions in-house, ensuring local ownership, operational autonomy, and compliance.",
  },
  {
    id: 2,
        ...
        {modelDetails.map((model, index) => (
          <div key={index} className="relative p-4 bg-[#D9D9D9] rounded-lg">
            <div className="flex items-end gap-4 my-4">
              ...
              />
              <div>
                <p className=" text-[#6D6D6D] text-4xl font-extrabold opacity-40 text-right mr-4 font-anton tracking-wider">
                  Model {index + 1}
                </p>
            ...
            <div className="flex items-center mt-4">
              <button className="mr-1">Learn More</button>
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
